                    ...
                    <div class="card-body">
                      ...
                      @csrf
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="" name="address" placeholder="" required>
                        </div>
                        <div class="form-row">
                          <div class="form-group col-md-6">
                            <label for="inputCity">lat</label>
                            <input type="text" class="form-control" name="lat" id="" required>
                          </div>
                          <div class="form-group col-md-6">
                            <label for="inputCity">lng</label>
                            <input type="text" class="form-control" id="" name="lng" required>
                          </div>
                        
                          <div class="form-group col-md-2">
                            <label for="inputZip">Profile</label>
                            <input type="file" class="form-control" id="" name="avatar" required>
                          </div>
                        </div>
                        <div class="form-group">
