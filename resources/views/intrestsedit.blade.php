                ...
                <div class="col-md-12">
                  <div class="card shadow mb-4">
                    <div class="card-header">
                      <strong class="card-title">AddIntrests</strong>
                    </div>
                    <div class="card-body">
                      <form  action="{{ route('editintrestaction') }}" method="POST" enctype="multipart/form-data">
                      @csrf
                <input type="hidden" name="id" value="{{$data['id']}}">
                        ...
                        <div class="form-row">
                          ...
                          <div class="form-group col-md-2">
                            ...
                            <input type="file" class="form-control" id="" name="icon" value="{{$data['icon']}}" required>
                          </div>
                        </div>
